...
class ChannelsTableViewController: UITableViewController {
    ...
    func loadChannels(){
        ...
        do
        {
            ...
            if result.count > 0
            {
                for usrkey in result as! [NSManagedObject]
                {
                    let name = usrkey.value(forKey: "channelName") as! String
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        guard let cell = tableView.dequeueReusableCell(withIdentifier: cellIdentifier, for: indexPath) as? ChannelsTableViewCell  else {
